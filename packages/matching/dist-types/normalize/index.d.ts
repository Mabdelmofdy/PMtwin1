...
export { resolveLocationCountry, resolveCoverage, evaluateLocationCoverage, extractCoverageScopes, } from './location-coverage.ts';
export type { LocationCountryCode, LocationCoverageTier, LocationCoverageResult, ResolvedCoverage, } from './location-coverage.ts';
